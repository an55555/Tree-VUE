...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_demoTree_vue__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_demoTree_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_demoTree_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0e2f8b25_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_demoTree_vue__ = __webpack_require__(345);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_demoTree_vue___default.a,
...
var update = __webpack_require__(127)("45ab14c5", content, false);
...
exports.default = {
    ...
    methods: {
        getRandomProject: function getRandomProject() {
            //                随机生成1到3条JSON
            var josnT = [];
        ...
        transmitMenuInfo: function transmitMenuInfo() {
            //  传递的参数: 当前名,当前ID,是否有儿子,层级图
            var menuArgs = {
                currentModel: this.model,
                treeLevel: this.currentLevel
            };
            _bus2.default.$emit(this.treeOption.callbackFn, menuArgs);
        },
        /*点击改变checkBox*/
        checkBoxStatusFn: function checkBoxStatusFn() {
        ...
        submitStatus: function submitStatus() {
            ...
            _bus2.default.$emit(this.treeOption.checkCallbackFn, menuArgs);
        },
        /*儿子变了，我得更新一下*/
        changeChildChecked: function changeChildChecked(val, index) {
    ...
    mounted: function mounted() {
        _bus2.default.$on('reloadTree', function (id) {
